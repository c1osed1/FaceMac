...
// Design system ported 1:1 from MacBookDuo (c1osed1/MacBookDuo).
...
/// Invisible helper that forces the hosting window into a transparent,
/// full-size titlebar — the chrome MacBookDuo uses.
...
/// White glyph on a coloured continuous rounded square — the signature element.
...
/// Full-size grouped `Form` scaffolding used by every pane.
...
/// Big centred icon + title + subtitle.
